...
for i = 1:no_samples
    ...
    if start == 1
        PrevFrmResd = CurrFrmSTResd; 
    else 
        [FrmBitStrm,~] = RPE_frame_coder(s0(start:finish),PrevFrmResd);
        [s0_dec(start:finish),CurrFrmResd] = RPE_frame_decoder(FrmBitStrm,PrevFrmResd);
